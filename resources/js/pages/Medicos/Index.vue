        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="grid auto-rows-min gap-4 md:grid-cols-4 grid-cols-2">
                ...
                <div class="col-span-1 md:col-span-1">
                    <Button @click="registrar" class="w-full cursor-pointer text-md">Registrar Médico</Button>
                </div>
            </div>
            <template v-if="props.medicos.data.length === 0">
                <div class="py-4 px-4 w-full bg-zinc-800 rounded-2xl text-xl">No hay registros de médicos</div>
            </template>
            <template v-else>
                <div
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead class="cursor-pointer" @click="toggleSort('telefono')">Teléfono
                                    </TableHead>
